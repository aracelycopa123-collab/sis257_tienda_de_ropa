...
const hideHeader = computed(() => {
  const pagesWithoutHeader = ['/login', '/dashboard', '/categorias', '/productos', '/clientes', '/ventas', '/checkout']
  return pagesWithoutHeader.some(page => route.path.startsWith(page))
})

// Páginas donde NO se muestra el footer
const hideFooter = computed(() => {
  const pagesWithoutFooter = ['/login', '/dashboard', '/categorias', '/productos', '/clientes', '/ventas', '/checkout']
